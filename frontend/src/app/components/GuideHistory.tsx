...
export function GuideHistory({ onClose }: GuideHistoryProps) {
  return (
    <motion.div
      className="fixed left-0 top-0 bottom-0 w-80 bg-gray-800 shadow-lg overflow-y-auto border-r border-gray-700 z-50"
      initial={{ x: "-100%" }}
      animate={{ x: 0 }}
      exit={{ x: "-100%" }}
    ...
    >
      <div className="flex flex-col h-full p-4">
        <div className="flex justify-between items-center mb-6 sticky top-0 bg-gray-800 py-2">
          <h2 className="text-2xl font-bold text-gray-100">Historial de Guías</h2>
        ...
        <div className="grid gap-4">
          {guides.map((guide) => (
            <div key={guide.id} className="bg-gray-700 p-3 rounded-lg text-gray-100">
